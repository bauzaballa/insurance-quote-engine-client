...
/**
 * Reusable Heading component with Figma typography variants
 ...
 * @param {string} as - HTML element to render (h1, h2, h3, h4, h5, h6, div, etc.)
 * @param {ReactNode} children - Content to render
 * @param {object} rest - Additional props passed to the element
 */
const HeadingApp = React.forwardRef(
  (
    {
      variant = '24px-bold-uppercase',
      color,
      as: Component = 'h1',
      children,
      className = '',
    ...
    const variantClass = variantMap[variant] || variantMap['24px-bold-uppercase'];
...
HeadingApp.displayName = 'HeadingApp';
